<form x-ref="categoryForm" method="post" :action="isEdit ? '{{ url('') }}' + '/category/' + selectedData.id : ''"
    class="min-w-96 space-y-5">
    @csrf
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
        ...
        <input id="name" type="text"
            ...
            name="name" placeholder="Enter account category" :value="selectedData ? selectedData.name : ''" />
    ...
    <div class="relative flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
        ...
        <select id="type" name="type"
            ...
            <option value="debit" :selected="selectedData ? selectedData.type === 'debit' : ''">Debit</option>
            <option value="credit" :selected="selectedData ? selectedData.type === 'credit' : ''">Credit</option>
        </select>
